                ...
                while($row = mysqli_fetch_assoc($res)){
                    ...
                    $diadevolucao = $row['datadevolucao'];
                        ...
                        if($diahoje > $diadevolucao){
                            ...
                            <td style='background-color: red;'> <a href='devolvercomum.php?id=" .$row['id']."'>Devolver</a> </td>
                            </tr>";
                        }else{
                            echo"   <tr>
                            ...
                            <td style='background-color: gray;'> <a href='devolvercomum.php?id=" .$row['id']."'>Devolver</a> </td>
                            </tr>";
                        }
                }
